...
export default function MessageDisplay({ message, isError = false, onDismiss }: MessageDisplayProps) {
  ...
  return (
    <div className={`mb-6 p-4 rounded-lg border-2 ${bgColor} ${textColor} flex items-start gap-3 shadow-md`}>
      {isError ? (
